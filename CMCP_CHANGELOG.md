...
- The provider-operator safety contract is documented in README; final `composer quality` is green with 18/18 tests and 104 assertions, branch-coverage execution, PHPStan, PHP-CS-Fixer, and production-manifest validation; changed PHP lint also passes.
